...
namespace OrionClientLib.CoinPrograms
{
    public class OreProgram
    {
        ...
        private static readonly PublicKey SlotHashesKey = new("SysvarS1otHashes111111111111111111111111111"); // these should be the same
        ...
        public static PublicKey ProgramId = new PublicKey("oreV2ZymfyeXgNgBdqMkumTqqAprVqgBWQfoYkrtKWQ"); // these need to be replaced with eclipse mainnet addresses when it goes live
